...
Create 3 GKE Kubernetes clusters in 3 regions e.g. west, central, and east.
Then use [kubefed](https://kubernetes.io/docs/admin/federation/kubefed/) to initialize and join only the west and central region
...
[Follow these steps to get set up](kubernetes-cluster-federation.md).
...
```
kubectl create -f replicasets/mongo-replicaset-pvc-rs0-us-scen1.yaml
```
...
```
kubectl create -f replicasets/pacman-replicaset-us-scen1.yaml
```
